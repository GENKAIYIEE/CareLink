  ...
  return (
    <header className="fixed top-0 z-40 bg-white border-b-2 border-slate-200 md:ml-64 md:w-[calc(100%-16rem)] flex justify-between items-center px-8 h-16 w-full">
      <div className="flex items-center gap-4">
        {/* Mobile Brand */}
        <span className="md:hidden text-2xl font-bold tracking-tight text-blue-900">CareLink</span>
        
        {/* Search */}
        <div className="hidden md:flex items-center bg-slate-100 rounded-full px-4 py-2 border-2 border-transparent focus-within:border-blue-900 focus-within:bg-white transition-colors">
      ...
      <div className="flex items-center gap-3 text-blue-900">
        ...
        <div className="h-10 w-10 bg-blue-900 text-white rounded-full flex items-center justify-center overflow-hidden border-2 border-blue-900 ml-1">
